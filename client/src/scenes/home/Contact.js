              ...
              <form  ref={form} onSubmit={sendEmail}>
                ...
                <div className="flex-form">
                  <div className="field-box1">
                      ...
                      <div className='field'>
                        <input id=" email" value={email} label="Email" placeholder="Email"  name="user_email" onChange={(e) => setEmail(e.target.value)}/>
                  ...
                  <div className="field-box2">
                    <div className='field message'>
                      <textarea id="message" value={message}  placeholder="Message" name="message" onChange={(e) => setMessage(e.target.value)}/>
